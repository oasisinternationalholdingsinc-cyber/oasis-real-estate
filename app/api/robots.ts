...
function getOpenAI() {
  ...
  if (!apiKey) {
    console.warn("[Partington Inquiry] OPENAI_API_KEY is not set. AI auto-reply skipped.");
    return null;
  }
          ...
          messages: [
            {
              ...
              content:
                ...
                "do NOT promise availability, mention executive-style main unit, and offer to coordinate viewing.",
            },
            {
              role: "user",
              content: `
        ...
        const autoReplyHtml = `
          <div style="font-family: system-ui; padding: 16px; background:#fafafa; color:#111;">
            ...
            <p style="margin-top:20px;font-size:12px;color:#888;">
              Oasis International Real Estate · Windsor Ontario
            </p>
          </div>
        `;
