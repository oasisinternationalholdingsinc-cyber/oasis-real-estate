  ...
  return (
    <AdminShell title="Inquiries">
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-2 items-center">
            <input
              ...
              className="w-full md:w-80 rounded-xl bg-slate-950 border border-slate-800 px-3 py-2 text-sm text-slate-100 outline-none focus:ring-1 focus:ring-amber-400"
            />
            <button
              onClick={() => load()}
        ...
        {/* Bulk actions */}
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between rounded-2xl border border-slate-900 bg-slate-950/70 p-3">
